...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      bgPattern: "bg-[radial-gradient(circle_at_70%_30%,rgba(100,116,139,0.3),transparent_50%)]"
    },
    {
      ...
      bgPattern: "bg-[radial-gradient(circle_at_20%_80%,rgba(107,114,128,0.3),transparent_50%)]"
    },
    {
      ...
      bgPattern: "bg-[radial-gradient(circle_at_80%_20%,rgba(99,102,241,0.3),transparent_50%)]"
    }
  ];
      ...
      <div className="container mx-auto relative z-10">
              ...
              >
                <div className={`${project.featured ? 'lg:flex' : ''}`}>
                  ...
                  <div className={`relative ${project.featured ? 'lg:w-1/2' : 'h-24'} bg-gradient-to-br ${project.gradient} ${project.bgPattern} flex items-center justify-center`}>
                    ...
                    <div className="absolute inset-0 overflow-hidden">
                      <div className="absolute -top-4 -right-4 w-24 h-24 bg-white/10 rounded-full blur-lg md:blur-xl animate-pulse md:animate-pulse"></div>
                      <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-white/5 rounded-full blur-md md:blur-lg animate-pulse delay-1000 md:animate-pulse md:delay-1000"></div>
                      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-white/5 rounded-full blur-xl md:blur-2xl animate-pulse delay-500 md:animate-pulse md:delay-500"></div>
                    </div>
                  ...
                  <div className={`p-3 ${project.featured ? 'lg:w-1/2 lg:flex lg:flex-col lg:justify-center' : ''}`}>
                    ...
                    <div className="flex gap-1">
                      <a
                        ...
                        className="flex items-center gap-1 px-2 py-1 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-all duration-200 text-xs shadow-sm hover:shadow-md hover:scale-105"
                      >
                        <Github size={12} />
                        Code
                      </a>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 border border-gray-300 rounded-md hover:bg-gray-200 transition-all duration-200 text-xs shadow-sm hover:shadow-md hover:scale-105"
                      >
        ...
        <div className="text-center mt-8">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center gap-2 px-8 py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
